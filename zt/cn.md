...
Permlink: [https://ckev.in/j/zt/cn.html](https://ckev.in/j/zt/cn.html)
版本：20210708
...
![图：云原生的挑战](img/pyramid-failure.png)
...
![图：典型开发和生产环境](img/prod-detail.png)
...
![图：用户访问自己的数据](img/bp-user-access.svg)

### 开发者改变软件数据访问行为

略

![图：开发者改变软件数据访问行为](img/bp-code-change.svg)
